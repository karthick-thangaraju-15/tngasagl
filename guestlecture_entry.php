        ...
        <ul class="list">
            ...
            <li class="active open"><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-assignment"></i><span>Forms</span></a>
                <ul class="ml-menu">
                    ...
                    <li class="active"><a href="form-examples.html">Form Examples</a></li>
        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="card">
                        <div class="header">
                            <h2><strong>Guest Lecture</strong> Entry</h2>
  ...
  */
  @media
    ...
    */
    ...
    td:nth-of-type(2):before { content: "UGC Qualified (S-I)"; }
    td:nth-of-type(3):before { content: "UGC Qualified (S-II)"; }
    td:nth-of-type(4):before { content: "Not Qualified (S-I)"; }
    td:nth-of-type(5):before { content: "Not Qualified (S-II)"; }
...
.pcwidth1{ width: 350px; }
.pcwidth2{ width: 110px; }
.pcwidth3{ width:110px; }
.pcwidth4{ width:110px; }
.pcwidth5{ width:110px; }
.pcwidth6{ width:110px; }
}
</style>
                            
        <div class="row clearfix" >
        <div class="col-md-12" id="add_fields">
         <div id="rows1">  
             <div  id="add_college1">                        
 <table role="table">
  <thead role="rowgroup">
    <tr role="row">
      ...
      <th role="columnheader" colspan="2" style="text-align: center;color:#007bff">UGC Qualified Guest Lecture</th>
      <th role="columnheader" colspan="2" style="text-align: center;color: #ce8200">Not Qualified Guest Lecture</th>
      <th role="columnheader" style="text-align: center;">Total</th>  
    </tr>
     <tr role="row">
      <th role="columnheader" ></th>
      
      <th role="columnheader"  style="text-align: center;">Shift 1</th>
        <th role="columnheader"  style="text-align: center;">Shift 2</th>
       <th role="columnheader" style="text-align: center;">Shift 1</th>
        <th role="columnheader" style="text-align: center;">Shift 2</th>
         <th role="columnheader" ></th>
    </tr>
  ...
  <tbody role="rowgroup">
    <tr role="row">
      <td role="cell"><select class="form-control pcwidth1" id="subject1_1" onchange="getsubject(this);" required="">
          <?php 
 $user_result2=mysqli_query($conn,"select CourseCode,`CourseName` from courselist where CollegeCode='1021001'   GROUP BY CourseName");
 echo "<option >Select any Option</option>";
    while($data1=mysqli_fetch_array($user_result2))
                         {
  echo "<option value=".$data1['CourseCode'].">".$data1['CourseName']."</option>";

                         }
          ?>
      </select></td>
      <td role="cell"> <input type="number" name="grade_month_year_1" class="form-control pcwidth2 numberk" placeholder=" " id=""    value=""    ></td>
      <td role="cell">   <input type="number" name="cgpa_1" class="form-control pcwidth3 numberk" placeholder=" " id="list1_1"    value=""    >  </td>
      <td role="cell"> <input type="number" name="grade_obt_mark_1" class="form-control pcwidth4 numberk" placeholder=" " id="obtcgpa1"    value=" "  ></td>
        <td role="cell"> <input type="number" name="grade_obt_mark_1" class="form-control pcwidth5 numberk" placeholder=" " id="obtcgpa1"    value=" "  ></td>

      <td role="cell"> <input type="number" name="grade_obt_mark_1" class="form-control pcwidth6" placeholder=" " id="obtcgpa1"    value=" " readonly="" ></td>
    </tr>
</tbody>
</table>
</div>
...
<style type="text/css">
   .theme-blush .nav-tabs .nav-link.active:hover{
    ...
    <li class="nav-item"><a class="nav-link active" id="addrows" style="">Add Subject</a></li>
    </ul> 
                            </div>
...
//alert("hai");
    i++;
   $('#add_fields').append('<div id="rows'+i+'"> <table><tbody role="rowgroup"><tr role="row"><td role="cell"><select class="form-control pcwidth1" required="" id="subject'+i+'_'+1+'" onchange="getsubject(this);"><?php 
 $user_result2=mysqli_query($conn,"select CourseCode,`CourseName` from courselist where CollegeCode='1021001'   GROUP BY CourseName");
 echo "<option >Select any Option</option>";
while($data1=mysqli_fetch_array($user_result2)){
echo "<option value=".$data1['CourseCode'].">".$data1['CourseName']."</option>";
}?></select></td><td role="cell"> <input type="number" name="grade_month_year_1" class="form-control pcwidth2 numberk" placeholder=" " id=""    value=""    ></td><td role="cell">   <input type="number" name="cgpa_1" class="form-control pcwidth3 numberk" placeholder=" " id="list1_1"    value="" style="text-transform: capitalize;"  >  </td><td role="cell"> <input type="number" name="grade_obt_mark_1" class="form-control pcwidth4 numberk" placeholder=" " id="obtcgpa1"    value=" "  ></td><td role="cell"> <input type="number" name="grade_obt_mark_1" class="form-control pcwidth5 numberk" placeholder=" " id="obtcgpa1"    value=" "  ></td><td role="cell"> <input type="number" name="grade_obt_mark_1" class="form-control pcwidth6" placeholder=" " id="obtcgpa1"  readonly=""  value=" "  ></td><td role="cell"><button type="button" onclick="del('+i+')" class="btn btn-icon btn-icon-mini btn-round btn-danger" id="del1"><i class="zmdi zmdi-delete"></i></button></td></tr></tbody></table></div>');
...
for(var idc=1;idci>idc;idc++)
{
    var val1=$('#subject'+idc+'_'+1).val();


    if(val1==value)
    {
         swal("Already This Subject has been Entered!");
